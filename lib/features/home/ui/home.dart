...
import 'package:martket_list/features/cart/ui/cart.dart';
import 'package:martket_list/features/home/bloc/home_bloc.dart';
import 'package:martket_list/features/home/ui/product_tile_widget.dart';
import 'package:martket_list/features/wishlist/ui/wishlist.dart';
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<HomeBloc, HomeState>(
      ...
      listenWhen: (previous, current) =>
          current is HomeActionState, // only listen action state
      buildWhen: (previous, current) =>
          current is! HomeActionState, //dont get action state
